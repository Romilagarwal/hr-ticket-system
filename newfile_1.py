...
if __name__ == '__main__':
    ...
    def setup_feedback_reminder_scheduler():
        scheduler = BackgroundScheduler()
        scheduler.add_job(
            func=send_pending_feedback_reminders,
            trigger=IntervalTrigger(days=1),
            id='feedback_reminders',
            name='Send daily feedback reminders',
            replace_existing=True
        )
        scheduler.start()
        print("📅 Feedback reminder scheduler started - will run daily at startup time")
# Call this function after your app initialization
    setup_feedback_reminder_scheduler()
